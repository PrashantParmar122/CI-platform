...
! function () {
        ...
        return function (e) {
            ...
            if (null != i) {
                var o, s, n = [],
                    ...
                    a = !1;
                try {
                    for (i = i.call(e); !(r = (o = i.next()).done) && (n.push(o.value), !t || n.length !== t); r = !0);
                } catch (e) {
                    a = !0, s = e
                } finally {
                    try {
    ...
    var p = function () {
        ...
        return t = e, o = [{
            ...
            value: function (t, i) {
                if (t) {
                    ...
                    e.getElements(t).forEach((function (e) {
                        var t;
                        (t = e.classList).remove.apply(t, r(o))
                    }))
                }
            }
        }, {
        ...
        }], (i = null) && u(t.prototype, i), o && u(t, o), Object.defineProperty(t, "prototype", {
            writable: !1
        }), e
    }();
    ...
    var O, S = {
        ...
        x = ["autofocus", "disabled", "multiple", "required"],
        w = ["autofocus", "class", "disabled", "id", "multiple", "name", "placeholder", "required"],
        ...
        E = function () {
            ...
            return t = e, o = [{
                ...
                value: function (e) {
                    ...
                    p.setAttrFromEle(t, n, Object.keys(O), x), t.parentNode.insertBefore(n, t), t.remove(), e.ele = n, e.options = s, e.disabledOptions = i, e.selectedValue = o
                }
            }, {
                key: "onFormReset",
                value: function (e) {
                ...
                value: function () {
                    if (this.$ele) {
                        var e = this.uniqueId,
                            ...
                            n = !1;
                        this.additionalClasses && (t += " ".concat(this.additionalClasses)), this.multiple && (t += " multiple", this.disableSelectAll || (t += " has-select-all")), this.hideClearButton || (t += " has-clear-button"), this.keepAlwaysOpen ? (t += " keep-always-open", n = !0) : t += " closed", this.showAsPopup && (t += " show-as-popup"), this.hasSearch && (t += " has-search-input"), this.showValueAsTags && (t += " show-value-as-tags"), this.textDirection && (t += " text-direction-".concat(this.textDirection)), this.popupPosition && (t += " popup-position-".concat(this.popupPosition.toLowerCase()));
                        var r = '<div id="vscomp-ele-wrapper-'.concat(e, '" class="vscomp-ele-wrapper ').concat(t, '" tabindex="0"\n        role="combobox" aria-haspopup="listbox" aria-controls="vscomp-dropbox-container-').concat(e, '"\n        aria-expanded="').concat(n, '" ').concat(s, '\n      >\n        <input type="hidden" name="').concat(this.name, '" class="vscomp-hidden-input">\n\n        <div class="vscomp-toggle-button">\n          <div class="vscomp-value" ').concat(i, ">\n            ").concat(this.placeholder, '\n          </div>\n\n          <div class="vscomp-arrow"></div>\n\n          <div class="vscomp-clear-button toggle-button-child" ').concat(o, '>\n            <i class="vscomp-clear-icon"></i>\n          </div>\n        </div>\n\n        ').concat(this.renderDropbox({
                            wrapperClasses: t
                        }), "\n      </div>");
                ...
                value: function () {
                    ...
                    if (a && (e = new RegExp("(".concat(this.searchValue, ")"), "gi")), this.multiple && (n = '<span class="checkbox-icon"></span>'), this.allowNewOption) {
                        var v = this.getTooltipAttrText("New Option");
                        r = '<span class="vscomp-new-option-icon" '.concat(v, "></span>")
                    }
                ...
                value: function () {
                    if (this.hasSearchContainer) {
                        ...
                        this.$search.innerHTML = i, this.$searchInput = this.$dropboxContainer.querySelector(".vscomp-search-input"), this.$searchClear = this.$dropboxContainer.querySelector(".vscomp-search-clear"), this.$toggleAllButton = this.$dropboxContainer.querySelector(".vscomp-toggle-all-button"), this.$toggleAllCheckbox = this.$dropboxContainer.querySelector(".vscomp-toggle-all-checkbox"), this.addEvent(this.$searchInput, "input", "onSearch"), this.addEvent(this.$searchClear, "click", "onSearchClear"), this.addEvent(this.$toggleAllButton, "click", "onToggleAllOptions")
                    }
                }
            }, {
                key: "addEvents",
                ...
                key: "onEnterPress",
                value: function (e) {
                    e.preventDefault(), this.isOpened() ? this.selectFocusedOption() : this.openDropbox()
                }
            }, {
                ...
                value: function () {
                    ...
                    if (this.hasDropboxWrapper) {
                        ...
                        this.mutationObserver = new MutationObserver((function (i) {
                            i.some((function (i) {
                                var o = y(i.removedNodes).some((function (e) {
                                    return !(e !== t && !e.contains(t))
                                }));
                                return o && e.destroy(), o
                            }))
                ...
                value: function () {
                    var e = this.getVisibleOptions(),
                        ...
                        i = !t && !e.length;
                    (!this.allowNewOption || this.hasServerSearch || this.showOptionsOnlyOnSearch) && p.toggleClass(this.$allWrappers, "has-no-search-results", i), p.toggleClass(this.$allWrappers, "has-no-options", t), this.setOptionAttr(), this.setOptionsPosition(), this.setOptionsTooltip()
                }
            }, {
                ...
                value: function () {
                    this.hasServerSearch ? this.serverSearch() : this.setVisibleOptionsCount(), this.selectAllOnlyVisible && this.toggleAllOptionsClass(), this.focusOption({
                        focusFirst: !0
                    })
                }
            }, {
                ...
                value: function (e) {
                    ...
                    Object.keys(O).forEach((function (i) {
                        var o = t.getAttribute(i); - 1 === x.indexOf(i) || "" !== o && "true" !== o || (o = !0), o && (e[O[i]] = o)
                    }))
                }
            }, {
                key: "setEleProps",
                ...
                value: function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                        ...
                        o = this.valueKey,
                        n = this.labelKey,
                        r = this.descriptionKey,
                        a = this.aliasKey,
                        l = this.hasOptionDescription,
                        u = s.getString,
                        p = s.convertToBoolean,
                        h = this.secureText.bind(this),
                        c = this.getAlias.bind(this),
                        d = 0,
                        f = !1,
                        y = {},
                        b = !1;
                    ...
                    var g = function e(s) {
                        ...
                        var g = h(u(s[o])),
                            ...
                            S = {
                                ...
                                label: h(u(s[n])),
                                alias: c(s[a]),
                                isVisible: p(s.isVisible, !0),
                                isNew: s.isNew || !1,
                                isGroupTitle: O,
                                classNames: s.classNames
                            };
                        if (b || "" !== g || (b = !0), i && (S.isDisabled = !0 === y[g]), s.isGroupOption && (S.isGroupOption = !0, S.groupIndex = s.groupIndex), l && (S.description = h(u(s[r]))), s.customData && (S.customData = s.customData), t.push(S), d += 1, O) {
                            var x = S.index;
                            f = !0, m.forEach((function (t) {
                                t.isGroupOption = !0, t.groupIndex = x, e(t)
                            }))
                        }
                    };
                    e.forEach(g);
                    var m = t.length,
                        O = this.$ele;
                    O.options = t, O.length = m, this.options = t, this.visibleOptionsCount = m, this.lastOptionIndex = m - 1, this.newValues = [], this.hasOptionGroup = f, this.hasEmptyValueOption = b, this.setSortedOptions()
                }
            }, {
                ...
                value: function () {
                    ...
                    s ? (this.setVisibleOptionsCount(), this.multiple && this.toggleAllOptionsClass(), this.setValueText()) : this.updatePosition(), p.removeClass(this.$allWrappers, "server-searching")
                }
            }, {
                ...
                value: function () {
                    ...
                    })), o && (e = [o].concat(y(e))), this.visibleOptions = e, this.renderOptions()
                }
            }, {
                ...
                value: function () {
                    var e = this.multiple,
                        ...
                        a = t.length,
                        l = 0,
                        u = this.isAllSelected && !this.hasServerSearch && !this.disableAllOptionsSelectedText && !o;
                    if (u && this.hideValueTooltipOnSelectAll) s.innerHTML = this.placeholder;///// changechange
                    else {
                        this.getSelectedOptions({
                            ...
                            var t = e.label;
                            if (n.push(t), l += 1, o) {
                                var s = '<span class="vscomp-value-tag" data-index="'.concat(e.index, '">\n              <span class="vscomp-value-tag-content">').concat(t, '</span>\n              <span class="vscomp-value-tag-clear-button">\n                <i class="vscomp-clear-icon"></i>\n              </span>\n            </span>');
                                r.push(s)
                            } else r.push(t);
                            return !1
                        }));
                        var h = a - i;
                        h > 0 && r.push('<span class="vscomp-value-tag more-value-count">+ '.concat(h, " ").concat(this.moreText, "</span>"));
                        var c = n.join(", ");
                        s.innerHTML = this.placeholder;
                        ///// changechange
                        /*if ("" === c) */
                        //else if (s.innerHTML = c, e) {
                        //    var d = this.maxValues;
                        //    if (p.hasEllipsis(s) || d || this.alwaysShowSelectedOptionsCount || o) {
                        //        var v = '<span class="vscomp-selected-value-count">'.concat(a, "</span>");
                        //        if (d && (v += ' / <span class="vscomp-max-value-count">'.concat(d, "</span>")), u) s.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(a, ")");
                        //        else if (o) s.innerHTML = r.join(""), this.$valueTags = s.querySelectorAll(".vscomp-value-tag"), this.setValueTagAttr();
                        //        else {
                        //            var f = 1 === a ? this.optionSelectedText : this.optionsSelectedText;
                    ...
                    var y = "";
                    0 === a ? y = this.placeholder : o || (y = r.join(", ")), p.setData(s, "tooltip", y), e && (p.setData(s, "tooltipEllipsisOnly", 0 === a), o && this.updatePosition())
                }
            }, {
                key: "setSearchValue",
                value: function (e) {
                ...
                value: function () {
                    var e, t = 0,
                        ...
                        a = this.isOptionVisible.bind(this);
                    this.hasOptionGroup && (e = this.getVisibleOptionGroupsMapping(o)), this.options.forEach((function (l) {
                        var u;
                        l.isCurrentNew || (n && !o ? (l.isVisible = !1, u = {
                            isVisible: !1,
                            hasExactOption: !1
                        }) : u = a({
                            data: l,
                    ...
                    })), this.allowNewOption && (o && !i ? (this.setNewOption(), t += 1) : this.removeNewOption()), this.visibleOptionsCount = t, this.afterSetVisibleOptionsCount()
                }
            }, {
                key: "setOptionProp",
                value: function (e, t, i) {
                ...
                value: function () {
                    ...
                    if (!this.showSelectedOptionsFirst && 0 !== e.length) {
                        var t, i = {};
                        e.forEach((function (e) {
                            i[e] = !0
                    ...
                    if (this.options.forEach((function (e) {
                        if (e.isSelected && !e.isGroupTitle)
                            if (i) l.push(e);
                                ...
                                var t, o = (d(t = {}, n, e.value), d(t, r, e.label), t);
                ...
                key: "openDropbox",
                value: function (e) {
                    this.isSilentOpen = e, e ? p.setStyle(this.$dropboxContainer, "display", "inline-flex") : (p.dispatchEvent(this.$ele, "beforeOpen"), p.setAria(this.$wrapper, "expanded", !0)), this.setDropboxWrapperWidth(), p.removeClass(this.$allWrappers, "closed"), this.dropboxPopover && !e ? this.dropboxPopover.show() : this.afterShowPopper()
                }
            }, {
                key: "afterShowPopper",
                value: function () {
                    var e = this.isSilentOpen;
                    this.isSilentOpen = !1, e || (this.moveSelectedOptionsFirst(), this.setScrollTop(), p.addClass(this.$allWrappers, "focused"), this.showAsPopup ? (p.addClass(this.$body, "vscomp-popup-active"), this.isPopupActive = !0) : this.focusSearchInput(), p.dispatchEvent(this.$ele, "afterOpen"))
                }
            }, {
                key: "closeDropbox",
                value: function (e) {
                ...
                value: function () {
                    ...
                    this.isSilentClose = !1, p.removeClass(this.$allWrappers, "focused"), this.removeOptionFocus(), e || this.isPopupActive && (p.removeClass(this.$body, "vscomp-popup-active"), this.isPopupActive = !1), p.addClass(this.$allWrappers, "closed"), e || p.dispatchEvent(this.$ele, "afterClose")
                }
            }, {
                ...
                key: "updatePosition",
                value: function () {
                    this.dropboxPopover && this.$ele.updatePosition()
                }
            }, {
                key: "isOpened",
                value: function () {
                ...
                value: function (e) {
                    ...
                    if (t) {
                        ...
                        n > l ? i = c + d : r < u && (i = c - a + h + d), void 0 !== i && (this.$optionsContainer.scrollTop = i)
                    }
                }
            }, {
                ...
                value: function (e) {
                    ...
                    if (e) {
                        ...
                        var n = this.selectedValues,
                            r = p.getData(e, "value"),
                            a = p.getData(e, "index", "number"),
                            l = p.hasClass(e, "current-new"),
                            u = !1,
                            h = this.lastSelectedOptionIndex;
                        if (this.lastSelectedOptionIndex = null, this.toggleSelectedProp(a, o), o) {
                            if (this.multiple) n.push(r), this.toggleAllOptionsClass(), this.toggleGroupOptionsParent(e), i && i.shiftKey && (u = !0);
                            else {
                                n.length && this.toggleSelectedProp(this.getOptionIndex(n[0]), !1), n = [r];
                                var c = this.$dropboxContainer.querySelector(".vscomp-option.selected");
                                c && this.toggleOptionSelectedState(c, !1), this.closeDropbox(), l || this.setSearchValue("")
                            }
                            this.lastSelectedOptionIndex = a, this.toggleOptionSelectedState(e)
                        } else this.multiple && (this.toggleOptionSelectedState(e), s.removeItemFromArray(n, r), this.toggleAllOptionsClass(!1), this.toggleGroupOptionsParent(e, !1));
                        l && this.beforeSelectNewValue(), this.setValue(n), u && this.selectRangeOptions(h, a)
                    }
                }
            }, {
                ...
                value: function (e) {
                    if (this.multiple && !this.disableSelectAll) {
                        "boolean" != typeof e && (e = !p.hasClass(this.$toggleAllCheckbox, "checked"));
                        var t = [],
                            i = this.selectAllOnlyVisible;
                        this.options.forEach((function (o) {
                            o.isDisabled || o.isCurrentNew || (!e || i && !o.isVisible ? o.isSelected = !1 : (o.isSelected = !0, o.isGroupTitle || t.push(o.value)))
                        })), this.toggleAllOptionsClass(e), this.setValue(t), this.renderOptions()
                    }
                }
            }, {
                ...
                value: function (e) {
                    if (this.multiple) {
                        ...
                        t || (e = this.isAllOptionsSelected()), p.toggleClass(this.$toggleAllCheckbox, "checked", e), this.selectAllOnlyVisible && t ? this.isAllSelected = this.isAllOptionsSelected() : this.isAllSelected = e
                    }
                }
            }, {
                ...
                value: function () {
                    var e = !1;
                    return this.options.length && this.selectedValues.length && (e = !this.options.some((function (e) {
                ...
                value: function (e, t) {
                    if (this.hasOptionGroup && !this.disableOptionGroupCheckbox && e) {
                        var i = p.getData(e, "groupIndex", "number"),
                            o = this.$options.querySelector('.vscomp-option[data-index="'.concat(i, '"]')),
                ...
                value: function (e) {
                    var t = e.data,
                        ...
                        l = t.label.toLowerCase(),
                        u = t.description,
                        p = t.alias,
                        h = r ? l.startsWith(i) : -1 !== l.indexOf(i);
                    return t.isGroupTitle && (n && h || (h = s[t.index])), r || !p || h || (h = -1 !== p.indexOf(i)), r || !u || h || (h = -1 !== u.toLowerCase().indexOf(i)), t.isVisible = h, o || (o = l === i || a === i), {
                        isVisible: h,
                        hasExactOption: o
                    }
                }
                ...
                key: "enable",
                value: function () {
                    this.$ele.disabled = !1, this.$ele.removeAttribute("disabled"), this.$hiddenInput.removeAttribute("disabled"), p.setAria(this.$wrapper, "disabled", !1)
                }
            }, {
                key: "disable",
                value: function () {
                    this.$ele.disabled = !0, this.$ele.setAttribute("disabled", ""), this.$hiddenInput.setAttribute("disabled", ""), p.setAria(this.$wrapper, "disabled", !0)
                }
            }, {
                key: "validate",
                value: function () {
                ...
                value: function () {
                    var e = this.$ele;
                    e.virtualSelect = void 0, e.value = void 0, e.innerHTML = "", this.hasDropboxWrapper && (this.$dropboxWrapper.remove(), this.mutationObserver.disconnect()), this.dropboxPopover && this.dropboxPopover.destroy(), p.removeClass(e, "vscomp-ele")
                }
            }, {
                ...
                value: function (e, t) {
                    e && (p.toggleClass(e, "focused", t), t && p.setAria(this.$wrapper, "activedescendant", e.id))
                }
            }]) && m(t.prototype, i), o && m(t, o), Object.defineProperty(t, "prototype", {
                writable: !1
            }), e
        }();
    document.addEventListener("reset", E.onFormReset), document.addEventListener("submit", E.onFormSubmit), window.addEventListener("resize", E.onResizeMethod), O = E.getAttrProps(), window.VirtualSelect = E, "undefined" != typeof NodeList && NodeList.prototype && !NodeList.prototype.forEach && (NodeList.prototype.forEach = Array.prototype.forEach)
}(),
    function () {
        "use strict";
                ...
                return (t = [{
                    ...
                    value: function () {
                        ...
                        var e, t, n, r = window.innerWidth,
                            ...
                            F = r + M,
                            G = this.offset;
                        G && (P += G, I -= G, M += G, F -= G), "auto" === C && (C = i.getMoreVisibleSides(this.$triggerEle).vertical);
                        var H = {
                            top: {
                                top: E - h - D,
                                left: k + $
                            ...
                            W = H[C];
                        if (E = W.top, k = W.left, A && ("top" === A ? E = x : "bottom" === A ? E = x + b - h : "left" === A ? k = w : "right" === A && (k = w + y - p)), k < M ? "left" === C ? n = "right" : k = M + f > m ? m - f : M : k + p > F && ("right" === C ? n = "left" : k = F + f < S ? S - d : F - p), E < P ? "top" === C ? n = "bottom" : E = P + c > O ? O - c : P : E + h > I && ("bottom" === C ? n = "top" : E = I + c < g ? g - v : I - h), n) {
                            var L = H[n];
                            "top" === (C = n) || "bottom" === C ? E = L.top : "left" !== C && "right" !== C || (k = L.left)
                        }
                        "top" === C ? (e = E + V, t = k) : "right" === C ? (e = E, t = k - V) : "left" === C ? (e = E, t = k + V) : (e = E - V, t = k);
                        var N = "translate3d(".concat(t, "px, ").concat(e, "px, 0)");
                        if (i.setStyle(this.$popperEle, "transform", N), i.setData(this.$popperEle, "fromLeft", t), i.setData(this.$popperEle, "fromTop", e), i.setData(this.$popperEle, "top", E), i.setData(this.$popperEle, "left", k), i.removeClass(this.$popperEle, o.join(" ")), i.addClass(this.$popperEle, "position-".concat(C)), this.hasArrow) {
                            var q = 0,
                                j = 0,
                                R = k + f,
                                B = E + c,
                                ...
                                K = s[C] || "";
                            "top" === C || "bottom" === C ? (q = y / 2 + S - R) < z ? q = z : q > p - z && (q = p - z) : "left" !== C && "right" !== C || ((j = b / 2 + g - B) < z ? j = z : j > h - z && (j = h - z)), i.setStyle(this.$arrowEle, "transform", "translate3d(".concat(q, "px, ").concat(j, "px, 0) ").concat(K))
                        }
                        ...
                        clearTimeout(this.enterDelayTimeout), clearTimeout(this.showDurationTimeout), this.exitDelayTimeout = setTimeout((function () {
                            if (e.$popperEle) {
                                var t = i.getData(e.$popperEle, "fromLeft"),
                                    ...
                                    n = "translate3d(".concat(t, "px, ").concat(s, "px, 0)"),
                                    r = e.hideDuration;
    ...
    function () {
        ...
        var t = function () {
            ...
            }]) && e(i, o), Object.defineProperty(i, "prototype", {
                writable: !1
            }), t
        }();
        ...
        var n = function () {
            ...
            return o = e, (n = [{
                ...
                value: function (i, o, s, n) {
                    i && (o = t.removeArrayEmpty(o.split(" "))).forEach((function (t) {
            ...
            }]) && s(o, n), Object.defineProperty(o, "prototype", {
                writable: !1
            }), e
        }();
        ...
        var a, l = {
            ...
            u = ["target", "position", "margin", "offset", "enterDelay", "exitDelay", "showDuration", "hideDuration", "transitionDistance", "updatePositionThrottle", "zIndex", "hideOnOuterClick", "showOnHover", "hideArrowIcon", "disableManualAction", "disableUpdatePosition"],
            p = function () {
                function e(t) {
                    ! function (e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                ...
                return i = e, s = [{
                    ...
                    value: function (e) {
                        var i = this,
                            ...
                            a = e.method,
                            l = e.throttle;
                        s && (r = t.removeArrayEmpty(r.split(" "))).forEach((function (e) {
                            var r = "".concat(a, "-").concat(e),
                                u = i.events[r];
                            u || (u = i[a].bind(i), l && (u = t.throttle(u, l)), i.events[r] = u), "add" === o ? n.addEvent(s, e, u) : n.removeEvent(s, e, u)
                        }))
                    }
                }, {
                    ...
                    value: function () {
                        var t = this.$ele;
                        t.popComp = this, t.show = e.showMethod, t.hide = e.hideMethod, t.updatePosition = e.updatePositionMethod, n.addClass(this.$ele, "pop-comp-ele"), n.addClass(this.$popover, "pop-comp-wrapper")
                    }
                }, {
                    ...
                    key: "show",
                    value: function () {
                        this.isShown() || (this.isShownForOtherTrigger() ? this.showAfterOtherHide() : (n.addClass(this.$popover, "pop-comp-disable-events"), this.$popover.popComp = this, this.beforeShow(), this.popper.show({
                            resetPosition: !0
                ...
                }]) && r(i.prototype, o), s && r(i, s), Object.defineProperty(i, "prototype", {
                    writable: !1
                }), e
            }();
